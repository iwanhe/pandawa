# Run from directory containing Apache access_log.nnnnnnnnn files, See Security Guide for 12.2.7
BEGIN {
    ...
    fixed["/OA_HTML/jsp/fnd/.*"] = 1;     # Wrong! see allowed_jsps_diag_tests.conf
...
NF > 9 {
   rc = $(NF-1)  # position of return code depends on LogFormat!
