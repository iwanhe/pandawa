...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(31792691678603503238)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7467901977645179926)
,p_plugin_id=>wwv_flow_imp.id(31792691678603503238)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7467902365741179926)
,p_plugin_id=>wwv_flow_imp.id(31792691678603503238)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7467902771022179926)
,p_plugin_id=>wwv_flow_imp.id(31792691678603503238)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(7467905489731179928)
,p_plugin_id=>wwv_flow_imp.id(31792691678603503238)
