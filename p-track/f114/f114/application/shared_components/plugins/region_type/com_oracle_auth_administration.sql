...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(6673265213803546261)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7640599470827675302)
,p_plugin_id=>wwv_flow_imp.id(6673265213803546261)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7640599848561675303)
,p_plugin_id=>wwv_flow_imp.id(6673265213803546261)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7640600239680675304)
,p_plugin_id=>wwv_flow_imp.id(6673265213803546261)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7640600678903675304)
,p_plugin_id=>wwv_flow_imp.id(6673265213803546261)
,p_attribute_scope=>'COMPONENT'
