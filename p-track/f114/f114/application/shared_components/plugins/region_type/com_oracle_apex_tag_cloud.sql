...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(9834485648710090800)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7517359114527716603)
,p_plugin_id=>wwv_flow_imp.id(9834485648710090800)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7517359522951716603)
,p_plugin_id=>wwv_flow_imp.id(9834485648710090800)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7517359909582716603)
,p_plugin_id=>wwv_flow_imp.id(9834485648710090800)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1119722559941982772)
,p_plugin_id=>wwv_flow_imp.id(9834485648710090800)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(7517361249544716631)
,p_plugin_id=>wwv_flow_imp.id(9834485648710090800)
