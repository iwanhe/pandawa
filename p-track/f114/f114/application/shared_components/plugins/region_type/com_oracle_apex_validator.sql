...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(6064781695460724506)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7468128920336444862)
,p_plugin_id=>wwv_flow_imp.id(6064781695460724506)
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1119721578439982637)
,p_plugin_id=>wwv_flow_imp.id(6064781695460724506)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(7468129943775444863)
,p_plugin_id=>wwv_flow_imp.id(6064781695460724506)
