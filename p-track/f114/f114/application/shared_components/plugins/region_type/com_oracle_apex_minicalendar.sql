...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(5988827611677353542)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7483724793671575604)
,p_plugin_id=>wwv_flow_imp.id(5988827611677353542)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7483725218965575605)
,p_plugin_id=>wwv_flow_imp.id(5988827611677353542)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1119721350500982626)
,p_plugin_id=>wwv_flow_imp.id(5988827611677353542)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(7483728023835575608)
,p_plugin_id=>wwv_flow_imp.id(5988827611677353542)
