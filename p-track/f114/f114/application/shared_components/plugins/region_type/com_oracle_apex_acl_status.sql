...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(6673262224616546251)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136688387333790326)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136688720318790326)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136689179188790326)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136689587672790326)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136689924484790327)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136690322784790327)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4136690739070790327)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4136691723221790329)
,p_plugin_id=>wwv_flow_imp.id(6673262224616546251)
,p_name=>'SOURCE_SQL'
