...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18523277301407872396)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(18523278723961872404)
,p_name=>'Job History'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523279298263872410)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523279714709872411)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523280100190872412)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523280514710872412)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(18523280827781872413)
,p_name=>'Email Project Statuses Send Job'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523282431594872416)
,p_query_column_id=>1
,p_column_alias=>'JOB'
,p_column_display_sequence=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523282856570872416)
,p_query_column_id=>2
,p_column_alias=>'STATUS'
,p_column_display_sequence=>1
,p_column_heading=>'Status'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523283251509872417)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523281277409872414)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523281679444872415)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523282023394872416)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(18523283673684872418)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(417227562351456642)
,p_name=>'Refresh on Edit'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(18523280827781872413)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(417227640539456643)
,p_event_id=>wwv_flow_imp.id(417227562351456642)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(18523280827781872413)
,p_attribute_01=>'N'
);
