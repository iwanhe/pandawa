...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(17341997135360822985)
...
unistr('        l_ms_end_txt  varchar2(300)  := ''The \00BFTarget" column displays the date the Milestone was forecast to be completed. Dates displayed in strike-through text indicate a due date that has been revised.  The "Actual\00BF column represents the actual co')
...
'        m := null;',
'        g_progress := ''1'';',
'        set_apex_session( p_app_id => p_app_id );',
'        for c1 in',
'        (',
...
'        if l_i_cnt > 0',
'           and',
'           get_build_option_status(p_app_id => p_app_id, p_bo_name => ''Project Issue'))
);
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(17341997135360822985)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(17341997242976822992)
,p_script_id=>wwv_flow_imp.id(17341997135360822985)
