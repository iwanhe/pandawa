...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(5985524383943560009)
...
'            select case when access_level_id = 3',
'                        and not exists (select null',
'                                        from eba_proj_status_users u2',
'                                        where u2.access_level_id = 4 ) then 4',
'                    else access_level_id',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(6856065585206602911)
,p_script_id=>wwv_flow_imp.id(5985524383943560009)
