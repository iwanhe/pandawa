...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(7840724386479505084)
...
'            return ''f?p='' || v(''APP_ID'') || '':137:'' || v(''APP_SESSION'') || '':::137:P137_ID:'' || c1.id;',
'        end loop;',
'        return null;',
'    end profile_url;',
'',
...
'            if apex_util.get_build_option_status(   p_application_id => p_a'))
);
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(6856066353373602959)
,p_script_id=>wwv_flow_imp.id(7840724386479505084)
