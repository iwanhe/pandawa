...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1869435336867512719)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2274525764577207417)
,p_plugin_id=>wwv_flow_imp.id(1869435336867512719)
