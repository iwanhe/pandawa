...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1609538928649187828)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2473320724902188215)
,p_plugin_id=>wwv_flow_imp.id(1609538928649187828)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2473321125505188215)
,p_plugin_id=>wwv_flow_imp.id(1609538928649187828)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2473321528423188215)
,p_plugin_id=>wwv_flow_imp.id(1609538928649187828)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2473321935595188215)
,p_plugin_id=>wwv_flow_imp.id(1609538928649187828)
,p_attribute_scope=>'COMPONENT'
