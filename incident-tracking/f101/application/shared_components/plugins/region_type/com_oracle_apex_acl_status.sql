...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1609535924050187777)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099305118608797342)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099305526826797342)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099305931360797343)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099306329510797343)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099306668213797343)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099307065296797343)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4099307469025797344)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4099308502491797345)
,p_plugin_id=>wwv_flow_imp.id(1609535924050187777)
,p_name=>'SOURCE_SQL'
