...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1461275463415736140)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2316444984479088514)
,p_plugin_id=>wwv_flow_imp.id(1461275463415736140)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(2316445453655088515)
,p_plugin_id=>wwv_flow_imp.id(1461275463415736140)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(874107450729964542)
,p_plugin_id=>wwv_flow_imp.id(1461275463415736140)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(2316446713644088517)
,p_plugin_id=>wwv_flow_imp.id(1461275463415736140)
