...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7433147636757269138)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(681251916755904461)
,p_plugin_id=>wwv_flow_imp.id(7433147636757269138)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(681252350657904461)
,p_plugin_id=>wwv_flow_imp.id(7433147636757269138)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(681252785490904470)
,p_plugin_id=>wwv_flow_imp.id(7433147636757269138)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(681253921544904472)
,p_plugin_id=>wwv_flow_imp.id(7433147636757269138)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(681254680924904473)
,p_plugin_id=>wwv_flow_imp.id(7433147636757269138)
