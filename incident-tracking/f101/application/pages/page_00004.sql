...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(211864473250941864)
...
,p_plug_required_role=>wwv_flow_imp.id(3204234467922058482)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(318128721537731283)
,p_plug_name=>'ACL Info'
,p_parent_plug_id=>wwv_flow_imp.id(211864473250941864)
...
'begin',
'    l_acl_enabled := eba_intrack_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'');',
'    l_acl_scope   := eba_intrack_fw.get_preference_value(''ACCESS_CONTROL_SCOPE'');',
'',
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(318128783697731284)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_imp.id(211864473250941864)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(318128946060731285)
,p_query_column_id=>1
,p_column_alias=>'READER_COUNT'
,p_column_display_sequence=>1
,p_column_heading=>'Readers'
,p_column_link=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:RP,31,RIR:IR_ACCESS_LEVEL_ID:Reader'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(318129055612731286)
,p_query_column_id=>2
,p_column_alias=>'CONTRIBUTOR_COUNT'
,p_column_display_sequence=>2
,p_column_heading=>'Contributors'
,p_column_link=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:RP,31,RIR:IR_ACCESS_LEVEL_ID:Contributor'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(318129086132731287)
,p_query_column_id=>3
,p_column_alias=>'ADMIN_COUNT'
,p_column_display_sequence=>3
,p_column_heading=>'Administrators'
,p_column_link=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:RP,31,RIR:IR_ACCESS_LEVEL_ID:Administrator'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1462575751997319370)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'attribute_06', 'eba_intrack_fw.get_preference_value(''ACCESS_CONTROL_SCOPE'')',
  'attribute_07', 'eba_intrack_fw.get_preference_value(''ACCESS_CONTROL_ENABLED'')')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2873890254438746029)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1739585962487445377)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2752088974097619693)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(2752065368902618135)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(1609197146392052049)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2873434072652666122)
,p_plug_name=>'Administration'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>wwv_flow_imp.id(1609179910711051998)
,p_plug_display_sequence=>10
,p_list_id=>wwv_flow_imp.id(2873410966419664302)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(1609198279175052051)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4401605036168857188)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1253524947850506134)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1253524554299498505)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1253525158932509345)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1358970670436978410)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(3204253173143287069)
...
'-- Set AC flag',
'eba_intrack_fw.set_preference_value(''ACCESS_CONTROL_ENABLED'',''Y'');',
'',
...
,p_internal_uid=>3204253173143287069
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1558991567944777117)
...
'  c integer;',
'begin',
'select count(*) into c from EBA_INTRACK_PRODUCT;',
':CNT_01 := c;',
'select count(*) into c from EBA_INTRACK_CATEGORY;',
':CNT_02 := c;',
'select count(*) into c from EBA_INTRACK_CUSTOMERS;',
':CNT_03 := c;',
'select count(*) into c from EBA_INTRACK_CUSTOMER_CONTACT;',
':CNT_04 := c;',
'select count(*) into c from EBA_INTRACK_NOTIFICATIONS;',
':CNT_05 := c;',
'select count(*) into c  from apex_application_build_options bo',
' where application_id = :APP_ID;',
':CNT_06 := c;',
'select count(*) into c from eba_intrack_errors;',
':CNT_07 := c;',
'',
'for c1 in (',
...
'end;'))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>1558991567944777117
);
