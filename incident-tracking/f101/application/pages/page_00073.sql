...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1436197768356403661)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1436198347911403663)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1436199542682403669)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1723965442441207580)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1609169348961051977)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1436197947836403663)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1723965442441207580)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1436198173336403663)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1436200943893403686)
,p_branch_action=>'f?p=&APP_ID.:74:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1436198173336403663)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1436198554755403663)
,p_name=>'P73_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1436198347911403663)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1436198759452403665)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1436199765896403670)
,p_name=>'P73_USERNAME_FORMAT1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1436199542682403669)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(1436200571995403683)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1723965505776207581)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1436197947836403663)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1723965602284207582)
,p_event_id=>wwv_flow_imp.id(1723965505776207581)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1436200664149403683)
...
'    -- create collections',
'    --',
'    apex_collection.CREATE_OR_TRUNCATE_COLLECTION (''EBA_INTRACK_BULK_USER_INVALID'');',
'    apex_collection.CREATE_OR_TRUNCATE_COLLECTION (''EBA_INTRACK_BULK_USER_VALID'');',
'    apex_collection.CREATE_OR_TRUNCATE_COLLECTION (''EBA_INTRACK_BULK_USER_CREATE'');',
'',
'    --------------------------------------------',
...
'                      p_collection_name => ''EBA_INTRACK_BULK_USER_INVALID'',',
'                      p_c001            => l_username,',
...
'            if l_valid then',
'                apex_collection.add_member(',
'                    p_collection_name => ''EBA_INTRACK_BULK_USER_VALID'',',
'                    p_c001            => upper(l_username));',
'                    commit;',
'            end if;',
'',
...
,p_process_when_button_id=>wwv_flow_imp.id(1436198173336403663)
,p_internal_uid=>1436200664149403683
);
