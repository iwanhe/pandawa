...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2881438386687454517)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1069700727149168906)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2881438386687454517)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1069701146482168906)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1069703890900168909)
,p_branch_name=>'Go To Page settings'
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1069700727149168906)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1069701518229168907)
,p_name=>'P70_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2881438386687454517)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1069701863945168907)
,p_name=>'P70_END_USER_STYLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2881438386687454517)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(318128508341731281)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1069700727149168906)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(318128582391731282)
,p_event_id=>wwv_flow_imp.id(318128508341731281)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1069703426065168909)
...
'            p_id => :P70_DESKTOP_THEME_STYLE_ID',
'            );',
'    end loop;',
'end if;'))
...
,p_process_when_button_id=>wwv_flow_imp.id(1069701146482168906)
,p_process_success_message=>'Application appearance settings updated successfully.'
,p_internal_uid=>1069703426065168909
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1069703019402168909)
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'  l_enabled boolean := case when :P70_END_USER_STYLE = ''Yes'' then true else false end;',
'begin',
'  for c1 in (',
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1069701146482168906)
,p_internal_uid=>1069703019402168909
);
