...
,p_step_template=>wwv_flow_imp.id(1609150431590051933)
,p_page_template_options=>'#DEFAULT#'
,p_page_component_map=>'03'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001336468681814289)
...
,p_plug_display_when_condition=>'eba_intrack_fw.get_preference_value(''FIRST_RUN'') = ''YES'''
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001336338748814288)
,p_plug_name=>'Welcome to &APPLICATION_TITLE.'
,p_parent_plug_id=>wwv_flow_imp.id(2001336468681814289)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001336515145814290)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001338690710814311)
,p_plug_name=>'ACL Level'
,p_parent_plug_id=>wwv_flow_imp.id(2001336515145814290)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(1609169123120051976)
,p_plug_display_sequence=>10
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001336658963814291)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001336776082814292)
...
'   and eba_intrack_fw.get_preference_value(''FIRST_RUN'') = ''YES'''))
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2001339148555814316)
,p_name=>'Feature Configuration'
,p_parent_plug_id=>wwv_flow_imp.id(2001336776082814292)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076605036635886234)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076605434285886235)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076605832744886235)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076606171312886235)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076606617362886236)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076607022420886236)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076607432021886236)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001340063114814325)
,p_plug_name=>'Users'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2001337315314814298)
,p_name=>'Users'
,p_parent_plug_id=>wwv_flow_imp.id(2001340063114814325)
,p_template=>wwv_flow_imp.id(1609169123120051976)
,p_display_sequence=>10
...
,p_ajax_enabled=>'Y'
,p_lazy_loading=>false
,p_query_row_template=>wwv_flow_imp.id(1609186449852052021)
,p_query_num_rows=>500
,p_query_options=>'DERIVED_REPORT_COLUMNS'
,p_csv_output=>'N'
,p_prn_output=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076599158695886223)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076601216265886226)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076600799048886225)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076599597932886224)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1385133189518686855)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076601566729886226)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076599969471886224)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1076600376254886225)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2001340143368814326)
,p_plug_name=>'Buttons'
,p_region_css_classes=>'step-container'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2012667432912073886)
...
,p_plug_display_condition_type=>'EXPRESSION'
,p_plug_display_when_condition=>'eba_intrack_fw.get_preference_value(''FIRST_RUN'') = ''NO'''
,p_plug_display_when_cond2=>'PLSQL'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1076602736767886228)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2001340143368814326)
...
,p_button_condition=>'eba_intrack_fw.get_preference_value(''FIRST_RUN'') = ''YES'''
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1076608100700886237)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2012667432912073886)
,p_button_name=>'OK'
...
,p_button_condition=>'eba_intrack_fw.get_preference_value(''FIRST_RUN'') = ''NO'''
,p_button_condition2=>'PLSQL'
,p_button_condition_type=>'EXPRESSION'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1076601962907886227)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2001337315314814298)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1076612451142886256)
,p_branch_name=>'Go To Page HOME'
,p_branch_action=>'f?p=&APP_ID.:HOME:&SESSION.::&DEBUG.:RP,::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1076602736767886228)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1076597770577886213)
,p_name=>'P1000_ACL_CONFIG'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2001338690710814311)
,p_item_default=>'PUBLIC_READONLY'
,p_prompt=>'Access Control Level'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_named_lov=>'ACCESS CONTROL SCOPE'
,p_lov=>'.'||wwv_flow_imp.id(3204239970700134932)||'.'
,p_field_template=>wwv_flow_imp.id(1624544819382440145)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1076598236221886219)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1076604022908886231)
,p_name=>'P1000_LOAD_SAMPLE_YN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2001336658963814291)
,p_item_default=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1076610549577886249)
,p_name=>'Refresh Users Region on Modal Close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(953671794400057766)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1076610985340886254)
,p_event_id=>wwv_flow_imp.id(1076610549577886249)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2001337315314814298)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1076611428071886254)
,p_name=>'Refresh on edit'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2001337315314814298)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1076611907677886254)
,p_event_id=>wwv_flow_imp.id(1076611428071886254)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1076609667851886247)
...
,p_internal_uid=>1076609667851886247
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1076608551337886246)
...
,p_process_when2=>'PLSQL'
,p_internal_uid=>1076608551337886246
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1076608883697886247)
...
,p_process_when_type=>'EXPRESSION'
,p_process_when2=>'PLSQL'
,p_internal_uid=>1076608883697886247
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1076609305327886247)
...
'    eba_intrack_fw.set_preference_value (''USERNAME_FORMAT'',''EMAIL'');',
'else',
'    eba_intrack_fw.set_preference_value (''USERNAME_FORMAT'',''STRING'');',
'end if;'))
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>1076609305327886247
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1076610097260886248)
,p_process_sequence=>10
...
'                collection_name = ''NEW_USERS''',
'            and',
'                lower(c001) not in (select distinct lower(username) from eba_intrack_users);',
'    exception',
'      when others then',
'        null;',
'    end;',
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1076602736767886228)
...
,p_internal_uid=>1076610097260886248
);
