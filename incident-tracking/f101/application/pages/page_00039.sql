...
,p_help_text=>'This page shows the number of incidents by product in a bar graph. Click the bar to drill down to more details. Change the "Open" filter to filter the results displayed on this page. Click the <strong>Reset</strong> button to reset the page.'
,p_page_component_map=>'17'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1739586215435445379)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2796238871876177178)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2808289668701253699)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2808289844536253700)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2808289668701253699)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2808290073812253702)
,p_name=>'P39_OPEN'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2808289668701253699)
,p_item_default=>'0'
,p_prompt=>'Open'
,p_source=>'0'
