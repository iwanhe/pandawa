...
,p_help_text=>'This page shows the number of incidents by customer in a bar graph. Click the bar to drill down to more details.'
,p_page_component_map=>'11'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1739586284092445380)
...
'       count(*) c, ',
'       customer,',
'    ''f?p=''||:APP_ID||'':2:''||:APP_SESSION||''::''||:DEBUG||'':2,RIR:IR_CUSTOMER:''||customer the_link',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2796401865263206487)
