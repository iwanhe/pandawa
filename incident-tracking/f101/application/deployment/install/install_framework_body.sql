...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(3312560159617354613)
,p_install_id=>wwv_flow_imp.id(2719947952873449465)
,p_name=>'Framework Body'
,p_sequence=>190
,p_script_type=>'INSTALL'
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'CREATE OR REPLACE PACKAGE BODY "EBA_INTRACK_FW" as',
...
'                    insert into eba_intrack_tags (tag, content_id, content_type )',
...
'                exception when no_data_found then',
'                    delete from eba_intrack_tags where content_id = p_content_id and tag = l_old_tags(i);',
...
'            merge into eba_intrack_tags_type_sum s',
...
'            merge into eba_intrack_tags_sum s',
...
'    is',
'    begin',
'        merge into eba_intrack_preferences dest',
...
'    begin',
'        -- Remove old errors',
'        delete from eba_intrack_errors where err_time <= current_timestamp - 21;',
'        -- Log the error.',
'        insert into eba_intrack_errors (',
'            app_id,',
'            app_page_id,',
'            app_user,',
'            user_agent,',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(1688767348839115674)
,p_script_id=>wwv_flow_imp.id(3312560159617354613)
