...
**Source:** http://gitlab.sonia.net/upstream/oracleebs/-/blob/main/Github/sync/oracle-dev-standards.md?ref_type=heads
...
| 1.1     | 2026-01    | Iwan Herdian    | Updated source reference, formatting improvements, added `sql` syntax highlighting on all code blocks |
