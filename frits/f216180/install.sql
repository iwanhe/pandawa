...
@@workspace/credentials/app_216180_push_notifications_credentials.sql
@@application/shared_components/workflow/task_definitions/form_it_request.sql
@@application/shared_components/workflow/task_definitions/form_request_it_trx.sql
...
@@application/shared_components/files/frits_reviewupdate_docx.sql
@@application/shared_components/files/frits_userreviewdetailrep_docx.sql
@@application/shared_components/files/frits_userreviewsummaryrep_docx.sql
@@application/shared_components/files/icons_nojorono_png.sql
@@application/shared_components/files/frits_userreviewformitrequestrep_docx.sql
@@application/shared_components/files/check_internet_connection_javascript_gif.sql
...
@@application/shared_components/email/templates/form_req_it_email.sql
@@application/shared_components/email/templates/form_req_it_email_v2.sql
@@application/shared_components/security/authentications/oracle_apex_accounts.sql
@@application/shared_components/security/authentications/authentication.sql
