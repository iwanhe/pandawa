...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30017086802317567871)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30017086959927567871)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30017089316312567873)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(30017086802317567871)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(30017087938093567872)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(30017089717742567874)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30017090092659567874)
,p_name=>'P10020_DESKTOP_THEME_STYLE_ID'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(30017086959927567871)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30017090789092567879)
...
,p_lov=>'.'||wwv_flow_imp.id(30017090884464567879)||'.'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(30017088022102567872)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(30017087938093567872)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(30017088773522567873)
,p_event_id=>wwv_flow_imp.id(30017088022102567872)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(30017091958774567880)
...
,p_internal_uid=>30017091958774567880
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(30017092342994567881)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_success_message=>'Application Appearance Settings Saved.'
,p_internal_uid=>30017092342994567881
);
