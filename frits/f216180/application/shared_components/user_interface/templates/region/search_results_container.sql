...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016875722033567694)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016876012491567694)
,p_plug_template_id=>wwv_flow_imp.id(30016875722033567694)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016876395397567694)
,p_plug_template_id=>wwv_flow_imp.id(30016875722033567694)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016876662305567695)
,p_plug_template_id=>wwv_flow_imp.id(30016875722033567694)
,p_name=>'Sub Regions'
