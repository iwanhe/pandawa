...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016844998144567680)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016845279843567680)
,p_plug_template_id=>wwv_flow_imp.id(30016844998144567680)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016845572801567681)
,p_plug_template_id=>wwv_flow_imp.id(30016844998144567680)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016845859331567681)
,p_plug_template_id=>wwv_flow_imp.id(30016844998144567680)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016846155164567681)
,p_plug_template_id=>wwv_flow_imp.id(30016844998144567680)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016846408287567681)
,p_plug_template_id=>wwv_flow_imp.id(30016844998144567680)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
