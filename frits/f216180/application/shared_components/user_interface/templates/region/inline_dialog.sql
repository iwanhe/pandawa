...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016853813410567684)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016854124127567684)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016854421559567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016854716036567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016855067357567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016855327261567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016855603674567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016855965226567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016856203218567685)
,p_plug_template_id=>wwv_flow_imp.id(30016853813410567684)
,p_name=>'Sub Regions'
