...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016863291844567689)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016863581173567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016863869394567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016864104340567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016864447283567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016864794483567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016865048224567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016865314331567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016865608400567689)
,p_plug_template_id=>wwv_flow_imp.id(30016863291844567689)
,p_name=>'Sub Regions'
