...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016858568293567687)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016858946504567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016859217349567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016859536737567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016859853503567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016860139478567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016860466077567687)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016860750296567688)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016861027563567688)
,p_plug_template_id=>wwv_flow_imp.id(30016858568293567687)
,p_name=>'Sub Regions'
