...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016848475404567682)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016848714823567682)
,p_plug_template_id=>wwv_flow_imp.id(30016848475404567682)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016849069858567682)
,p_plug_template_id=>wwv_flow_imp.id(30016848475404567682)
,p_name=>'Sub Regions'
