...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016873211571567693)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016873555097567693)
,p_plug_template_id=>wwv_flow_imp.id(30016873211571567693)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016873844373567693)
,p_plug_template_id=>wwv_flow_imp.id(30016873211571567693)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016874119416567693)
,p_plug_template_id=>wwv_flow_imp.id(30016873211571567693)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016874438524567694)
,p_plug_template_id=>wwv_flow_imp.id(30016873211571567693)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016874733151567694)
,p_plug_template_id=>wwv_flow_imp.id(30016873211571567693)
,p_name=>'Sub Regions'
