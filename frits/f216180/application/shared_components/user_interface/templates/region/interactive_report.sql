...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016868628684567691)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016868963405567691)
,p_plug_template_id=>wwv_flow_imp.id(30016868628684567691)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016869221958567691)
,p_plug_template_id=>wwv_flow_imp.id(30016868628684567691)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016869578027567691)
,p_plug_template_id=>wwv_flow_imp.id(30016868628684567691)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016869887387567691)
,p_plug_template_id=>wwv_flow_imp.id(30016868628684567691)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016870117479567691)
,p_plug_template_id=>wwv_flow_imp.id(30016868628684567691)
,p_name=>'Sub Regions'
