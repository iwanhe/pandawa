...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016895951445567703)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016896249994567704)
,p_plug_template_id=>wwv_flow_imp.id(30016895951445567703)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016896556029567704)
,p_plug_template_id=>wwv_flow_imp.id(30016895951445567703)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016896844003567704)
,p_plug_template_id=>wwv_flow_imp.id(30016895951445567703)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016897195459567704)
,p_plug_template_id=>wwv_flow_imp.id(30016895951445567703)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016897410868567704)
,p_plug_template_id=>wwv_flow_imp.id(30016895951445567703)
