...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016812997397567665)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016813369874567665)
,p_plug_template_id=>wwv_flow_imp.id(30016812997397567665)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016813689063567665)
,p_plug_template_id=>wwv_flow_imp.id(30016812997397567665)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016813977593567665)
,p_plug_template_id=>wwv_flow_imp.id(30016812997397567665)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016814244266567665)
,p_plug_template_id=>wwv_flow_imp.id(30016812997397567665)
,p_name=>'Sub Regions'
