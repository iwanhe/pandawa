...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016840383418567678)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016840629888567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016840974266567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016841275847567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016841515883567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016841867221567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016842134730567678)
,p_plug_template_id=>wwv_flow_imp.id(30016840383418567678)
,p_name=>'Sub Regions'
