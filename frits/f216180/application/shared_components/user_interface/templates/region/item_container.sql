...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016870786791567691)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016871032874567692)
,p_plug_template_id=>wwv_flow_imp.id(30016870786791567691)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016871316884567692)
,p_plug_template_id=>wwv_flow_imp.id(30016870786791567691)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016871609596567692)
,p_plug_template_id=>wwv_flow_imp.id(30016870786791567691)
,p_name=>'Button Start'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(32999856510424844146)
,p_plug_template_id=>wwv_flow_imp.id(30016870786791567691)
,p_name=>'Sub Regions'
