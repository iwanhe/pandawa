...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016818715859567667)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016819039533567667)
,p_plug_template_id=>wwv_flow_imp.id(30016818715859567667)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016819366925567668)
,p_plug_template_id=>wwv_flow_imp.id(30016818715859567667)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016819620064567668)
,p_plug_template_id=>wwv_flow_imp.id(30016818715859567667)
,p_name=>'Sub Regions'
