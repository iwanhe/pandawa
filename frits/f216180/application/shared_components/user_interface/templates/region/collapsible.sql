...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(30016830580254567674)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016830836597567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016831171595567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016831413152567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016831793551567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016832092391567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016832322573567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016832699887567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016832935229567674)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016833234692567675)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016833518911567675)
,p_plug_template_id=>wwv_flow_imp.id(30016830580254567674)
,p_name=>'Sub Regions'
