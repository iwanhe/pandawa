...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30016804781161567659)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016805005292567659)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016805389640567660)
,p_page_template_id=>wwv_flow_imp.id(30016804781161567659)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016805623058567660)
,p_page_template_id=>wwv_flow_imp.id(30016804781161567659)
