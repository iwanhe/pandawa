...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30015775364420567640)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015775600287567643)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015776004135567643)
,p_page_template_id=>wwv_flow_imp.id(30015775364420567640)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015776324483567643)
,p_page_template_id=>wwv_flow_imp.id(30015775364420567640)
