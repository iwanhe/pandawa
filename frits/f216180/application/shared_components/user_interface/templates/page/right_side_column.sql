...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30015797663617567656)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015797920786567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015798277055567656)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015798524225567656)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015798878730567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015799137931567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015799445549567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015799700932567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015800058288567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016800314136567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016800645788567657)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30016800929235567658)
,p_page_template_id=>wwv_flow_imp.id(30015797663617567656)
