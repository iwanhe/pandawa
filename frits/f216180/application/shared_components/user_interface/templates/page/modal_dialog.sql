...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30015796163519567655)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015796485813567655)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015796759812567655)
,p_page_template_id=>wwv_flow_imp.id(30015796163519567655)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015797008847567656)
,p_page_template_id=>wwv_flow_imp.id(30015796163519567655)
