...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(30015786131997567650)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015786449774567650)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015786700351567650)
,p_page_template_id=>wwv_flow_imp.id(30015786131997567650)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015787085155567650)
,p_page_template_id=>wwv_flow_imp.id(30015786131997567650)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(30015787377503567651)
,p_page_template_id=>wwv_flow_imp.id(30015786131997567650)
,p_name=>'Body Footer'
