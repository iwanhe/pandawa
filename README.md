...
* **PLSQL** (85.1%) - PL/SQL untuk Oracle Database
* **JavaScript** (7.2%) - Untuk keperluan web dan UI
* **HTML** (2.7%) - Markup untuk dokumentasi dan interface
* **PLpgSQL** (2.2%) - PostgreSQL procedural language
* **Java** (2.1%) - Untuk integrasi dan tools
